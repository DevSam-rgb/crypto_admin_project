...
import 'package:crypto_admin/widgets/crypto_trade_tile.dart';
...
class UserTradeScreen extends StatefulWidget {
  const UserTradeScreen({super.key});

  @override
  State<UserTradeScreen> createState() => _UserTradeScreenState();
}

class _UserTradeScreenState extends State<UserTradeScreen> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10,),
              CryptoTile(status: "Trade Successful", timeAgo: "2 hours ago", amount: "500,000"),
              CryptoTile(status: "Trade Successful", timeAgo: "2 hours ago", amount: "500,000"),
              CryptoTile(status: "Trade Successful", timeAgo: "2 hours ago", amount: "500,000"),
              CryptoTile(status: "Trade Successful", timeAgo: "2 hours ago", amount: "500,000"),
              CryptoTile(status: "Trade Successful", timeAgo: "2 hours ago", amount: "500,000"),

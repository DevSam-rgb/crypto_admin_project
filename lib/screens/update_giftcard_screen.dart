...
class UpdateGiftCardScreen extends StatefulWidget {
  @override
  State<UpdateGiftCardScreen> createState() => _UpdateGiftCardScreenState();
}

class _UpdateGiftCardScreenState extends State<UpdateGiftCardScreen> {
  @override
